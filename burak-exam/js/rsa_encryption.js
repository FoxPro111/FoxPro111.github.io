...
function main() {
	var alert = '';
	var message = document.getElementById('povidomlennya').value != '' ? document.getElementById('povidomlennya').value : '35';
	var numberTwo = document.getElementById('KU-1').value != '' ? document.getElementById('KU-1').value : '29';
	var numberSimple = document.getElementById('KU-2').value != '' ? document.getElementById('KU-2').value : '91';

	var encryptShifr = encrypt(message, numberTwo, numberSimple, 1);
